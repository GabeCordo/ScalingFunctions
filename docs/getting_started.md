...
Yule is a powerful framework that allows you to build multithreaded pipelines in a couple lines of code. The pipelines
...
```shell
go install git@github.com:GabeCordo/Yule.git
```
